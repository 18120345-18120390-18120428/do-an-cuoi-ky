//
//  Top10ViewsViewController.swift
//  DoAnCuoiKy
//
...
class Top10ViewsViewController: UIViewController {
    var titile = ""
    ...
    func fetchStories() {
        ...
        ref.child("Stories").queryOrdered(byChild: "views").queryLimited(toLast: 10).observeSingleEvent(of: .value, with: {snapshot in
...
extension Top10ViewsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lbUpdateDay.text = "Lượt xem: \(data[indexPath.row].views)"
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "top10views", sender: self)
    }
